...
SELECT c.customer_id, customer_first_name, customer_last_name, SUM(quantity*cost_to_customer_per_qty) AS amount_spent 
FROM customer as c INNER JOIN customer_purchases cp 
...
SELECT customer_id, SUM(quantity*cost_to_customer_per_qty) AS amount_spent_april_2022
FROM customer_purchases
